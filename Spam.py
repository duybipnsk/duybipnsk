...
amount = 5000
sdt = input("[ + ] Số điện thoại spam ( phiên bản beta 1.0 ) : ")
...
def run(sdt,i):                  
  ...
  threading.submit(KILO,sdt)
  threading.submit(GAPO,sdt) 
  print("Send Sms | Api - FVip | Delay : 5 tùy thuộc Spam Lúc Được Lúc Không | Status : Thành Công ",)  
  for j in range(0, 5):
    # code trong vòng lặp
    print(f"telgram@duyddos\r",end="")
